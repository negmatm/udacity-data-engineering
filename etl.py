...
def process_log_file(cur, filepath):
    ...
    t_df = pd.DataFrame(t)
    time_df = t_df.assign(hour = t_df.ts.dt.hour, day = t_df.ts.dt.day, weekday = t_df.ts.dt.weekday, week = t_df.ts.dt.week, month = t_df.ts.dt.month, year = t_df.ts.dt.year)
